function [pcorr_pos,pcorr_neg] = tfce_correlation_twotailed(imgs,covariate,varargin)
...
% maximize power. This version performs two-tailed tests, searching for
...
%
%   Output:
%   pcorr_pos -- wholebrain map of corrected p-values for positive Rs
%   pcorr_neg -- wholebrain map of corrected p-values for negative Rs
...
[scvals,cind] = sort(abs(truestat),1,'descend');
